import{s as R,b as j,n as H,r as ce,j as de,h as fe,o as ue}from"../chunks/scheduler.DJcLnUSX.js";import{S as P,i as A,e as g,s as _,c as x,a as $,y as z,f as L,d as b,k as p,p as y,g as I,h as u,z as he,t as ae,b as ne,A as ve,B as Q,u as q,C as me,v as N,w as K,l as D,m as B,o as pe,x as O,q as be}from"../chunks/index.EcrCpfSL.js";import{u as W,d as J,s as G,g as ge}from"../chunks/base.Cmuntu6m.js";const xe=typeof window<"u"?window:typeof globalThis<"u"?globalThis:global;function Y(o){return(o==null?void 0:o.length)!==void 0?o:Array.from(o)}const we={};function X(o,e={}){o.classList.add("exio-component");let s=document.querySelector("#exio-styles");if(!s){s=document.createElement("style"),s.id="exio-styles";const t=window.location.protocol==="http:"?"http:":"https:";s.innerHTML=`
      .exio-component {
        /* --------------------------- */
  ...
  `,{...W(e,o,Le),...J(()=>{t.remove(),s.destroy()})}}const Te=.05;function te(o,e,s){const t=o.slice();return t[2]=e[s],t[4]=s,t}function oe(o){let e,s,t,i,l=o[2].title+"",f,h,n,a;function c(...r){return o[1](o[2],...r)}return{c(){e=g("a"),s=g("div"),t=g("button"),i=g("div"),f=ae(l),h=_(),this.h()},l(r){e=x(r,"A",{href:!0,target:!0,style:!0,class:!0});var v=$(e);s=x(v,"DIV",{style:!0,class:!0});var d=$(s);t=x(d,"BUTTON",{class:!0});var m=$(t);i=x(m,"DIV",{class:!0});var k=$(i);f=ne(k,l),k.forEach(b),m.forEach(b),d.forEach(b),h=L(v),v.forEach(b),this.h()},h(){p(i,"class","title svelte-1b6p00k"),p(t,"class","popup paper-link svelte-1b6p00k"),t.disabled=!!("disabled"in o[2]&&o[2].disabled),y(s,"animation-delay",(o[4]+1)*Te+"s"),p(s,"class","svelte-1b6p00k"),p(e,"href",o[2].url),p(e,"target","_blank"),y(e,"text-decoration","none"),p(e,"class","svelte-1b6p00k")},m(r,v){I(r,e,v),u(e,s),u(s,t),u(t,i),u(i,f),u(e,h),n||(a=[j(_e.call(null,t)),j(le.call(null,s)),ve(e,"click",c)],n=!0)},p(r,v){o=r},d(r){r&&b(e),n=!1,ce(a)}}}function Ee(o){let e,s,t,i=`<div class="info svelte-1b6p00k"><div class="name svelte-1b6p00k">Joint-Task Regularization for Partially Labeled Multi-Task Learning</div> <div class="text-center svelte-1b6p00k" style="font-weight: bold;">CVPR 2024</div> <div class="affiliation svelte-1b6p00k"><div class="text-center svelte-1b6p00k"><span class="no-break svelte-1b6p00k"><a target="_blank" href="https://kentonishi.com/" class="svelte-1b6p00k">Kento Nishi</a>*</span>,
